<x-articleapp-layout>
    ...
    <div class="mb-20 flex justify-center items-center">
        <div class="flex space-x-52">
            ...
            <div class="text-center">
                ...
                <p class="text-xl font-bold text-gray-800">admin@sman10kotatangerang.sch.id</p>
            ...
            <a href="https://maps.app.goo.gl/G5DwscKBRhxMi6FK8" class="text-center cursor-pointer">
                ...
                <p class="w-40 text-xl font-bold text-gray-800">Jl. Raya Cipondoh, Poris Plawad Indah, Kota Tangerang, Banten</p>
    ...
    <!-- form container
     <div class="mb-32 flex flex-col justify-center items-center">
        <div>
            <p class="p-10 text-5xl text-black text-center font-bold">
                Ingin Bertanya?
            </p>
            <p class="text-xl">
                Silahkan isi form dibawah dan kami akan segera hubungi anda.
            </p>
        </div>
